...
CREATE TABLE `evaluations` (
  ...
  `status` enum('pending','completed','submitted','locked') DEFAULT 'pending',
...
INSERT INTO `evaluation_criteria` (`id`, `name`, `description`, `weight`, `max_score`, `created_at`) VALUES
(1, 'Clarity', 'Presentation clarity and communication effectiveness', 30.00, 5, '2026-02-24 17:46:24'),
(2, 'Subject Mastery', 'Content knowledge and expertise demonstrated', 40.00, 5, '2026-02-24 17:46:24'),
(3, 'Engagement', 'Ability to motivate and engage students', 30.00, 5, '2026-02-24 17:46:24'),
(4, 'Clarity', 'Presentation clarity and communication effectiveness', 30.00, 5, '2026-02-24 17:51:24'),
(5, 'Subject Mastery', 'Content knowledge and expertise demonstrated', 40.00, 5, '2026-02-24 17:51:24'),
(6, 'Engagement', 'Ability to motivate and engage students', 30.00, 5, '2026-02-24 17:51:24'),
(7, 'Clarity', 'Presentation clarity and communication effectiveness', 30.00, 5, '2026-02-24 17:52:54'),
(8, 'Subject Mastery', 'Content knowledge and expertise demonstrated', 40.00, 5, '2026-02-24 17:52:54'),
(9, 'Engagement', 'Ability to motivate and engage students', 30.00, 5, '2026-02-24 17:52:54');
...
CREATE TABLE `evaluation_forms` (
  ...
  `name` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `type` enum('student-to-teacher','peer-review','self-evaluation','admin-evaluation') NOT NULL,
  `criteria` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`criteria`)),
  `is_published` tinyint(1) DEFAULT 0,
  `ched_compliant` tinyint(1) DEFAULT 1,
...
INSERT INTO `evaluation_forms` (`id`, `name`, `description`, `type`, `criteria`, `is_published`, `ched_compliant`, `responses`, `created_at`, `updated_at`) VALUES
(1, 'Student Evaluation of Teaching', 'Comprehensive form for students to evaluate instructor performance', 'student-to-teacher', '[{\"id\":\"criteria-1772722189769-0.6592404675554104\",\"name\":\"Course Organization\",\"description\":\"How well is the course organized?\",\"weight\":20,\"maxScore\":5},{\"id\":\"criteria-1772722189769-0.49795440456706064\",\"name\":\"Teaching Effectiveness\",\"description\":\"How effectively does the instructor teach?\",\"weight\":25,\"maxScore\":5},{\"id\":\"criteria-1772722189769-0.4703407722163926\",\"name\":\"Communication Skills\",\"description\":\"How clear is the instructor\'s communication?\",\"weight\":20,\"maxScore\":5},{\"id\":\"criteria-1772722189769-0.9237946250660741\",\"name\":\"Student Engagement\",\"description\":\"How well does the instructor engage students?\",\"weight\":20,\"maxScore\":5},{\"id\":\"criteria-1772722189769-0.7705421229750851\",\"name\":\"Assessment Methods\",\"description\":\"How fair and clear are the assessment methods?\",\"weight\":15,\"maxScore\":5}]', 1, 1, 0, '2026-03-05 14:50:02', '2026-03-15 02:13:15');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `is_active`, `course`, `created_at`, `updated_at`) VALUES
('3fc28442-f332-471a-9d72-2819329c0aa5', 'Liza Nazareno', 'liza.nazareno@jmc.edu.ph', 'nazareno123', 'student', 1, 'BSIT', '2026-02-25 08:56:57', '2026-02-25 08:56:57'),
('7f2c816c-b11d-4ae4-9497-ce3a766b54f7', 'Ruby  Mae', 'rubymae.ones@jmc.edu.ph', 'khakibaby', 'student', 1, 'BSIT', '2026-02-24 18:07:09', '2026-02-24 18:07:09'),
('admin-1', 'Admin User', 'admin@jmc.edu.ph', 'admin123', 'dean', 1, 'BSIT', '2026-02-24 17:55:33', '2026-02-24 17:55:33'),
('af950cb1-cc84-4ae6-a7ae-d68348bcd9de', 'Ryan Billera', 'ryan.billera@jmc.edu.ph', 'ryan1234', 'teacher', 1, NULL, '2026-02-24 18:08:30', '2026-02-24 18:08:30'),
('eacf5742-b0e7-44fb-a87a-8459f2f1580e', 'Milller Lana', 'miller.lana@jmc.edu.ph', 'miller1234', 'student', 1, 'BSEMC', '2026-02-25 03:46:14', '2026-02-25 03:46:14'),
('student-1', 'Student User', 'student@jmc.edu.ph', 'student123', 'student', 1, 'BSIT', '2026-02-24 17:55:33', '2026-02-24 17:55:33'),
('teacher-1', 'Teacher User', 'teacher@jmc.edu.ph', 'teacher123', 'teacher', 1, 'BSIT', '2026-02-24 17:55:33', '2026-02-24 17:55:33');
...
ALTER TABLE `evaluations`
  ...
  ADD CONSTRAINT `evaluations_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `evaluation_responses`
  ...
  ADD CONSTRAINT `evaluation_responses_ibfk_2` FOREIGN KEY (`criteria_id`) REFERENCES `evaluation_criteria` (`id`) ON DELETE CASCADE;
